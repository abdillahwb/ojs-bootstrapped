...
{/if}
	...
	<tr valign="top">
		<td >
			<img src="{$publicFilesDir}/{$pageHeaderTitleImage[$formLocale].uploadName|escape:"url"}" style="border: 0; max-height: 100%; max-width: 100%; width: 100%;" alt="{translate key="admin.settings.homeHeaderImage.altText"}" />
		</td>
	</tr>
	<tr valign="top">
		<td >
	...
	<tr valign="top">
		<td class="value" ><input type="checkbox" id="oneStepReset" name="oneStepReset" {if $oneStepReset}checked="checked" {/if}/>
		{fieldLabel name="oneStepReset" key="admin.settings.oneStepReset"}</td>
	</tr>
	<tr>
...
{if count($availableMetricTypes) > 2}
	...
	<div id="defaultMetricSelection">
		...
		<table class="data" width="100%">
			<tr valign="top">
				<td  class="label">{fieldLabel name="defaultMetricType" key="defaultMetric.availableMetrics"}</td>
				<td   class="value">
